...
<br>
<?php 
  $giver = array($_POST["name1"], $_POST["name2"], $_POST["name3"], $_POST["name4"], $_POST["name5"], $_POST["name6"], $_POST["name7"]);
  $receiver = array($_POST["name1"], $_POST["name2"], $_POST["name3"], $_POST["name4"], $_POST["name5"], $_POST["name6"], $_POST["name7"]);
